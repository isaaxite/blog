...
| Icon                            | Name                                               | Desc                                                                                               |
| ------------------------------- | -------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| ![](file-20250331080903896.png) | [Rhythmbox](https://wiki.gnome.org/Apps/Rhythmbox) | **GNOME** 桌面环境默认的**音乐播放与管理软件**，适用于 **Linux** 系统。它提供音频播放、音乐库管理、网络电台、播客支持等功能，界面简洁易用，适合日常听歌和轻度音乐整理需求。 |
| ![](file-20250331080959345.png) | [Amberol](https://apps.gnome.org/Amberol/)         | 一款轻量级、现代化的 **Linux 音乐播放器**，专为 **GNOME 桌面环境**设计。它专注于**简洁播放体验**，界面极简，适合快速播放本地音乐文件，无复杂功能干扰。           |
