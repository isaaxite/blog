---
title: PM2 日志插件（pm2-logrotate）使用
slugpath: usage/pm2-logrotate
alias:
- blog/pm2-logrotate-plugin-usage/
- blog/resources/PM2日志优化/
...
1. 缺少日志时间戳；
2. 缺少日志分片；
3. 没有日志 rotate 功能，定期清除防止磁盘爆满

<!-- more -->

## PM2 自带的日志

[PM2 Docs > LOGS](https://pm2.keymetrics.io/docs/usage/log-management/)
