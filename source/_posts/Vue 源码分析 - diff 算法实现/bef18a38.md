...
<img src="bef18a38/diff-vnode.png" width="100%" alt="vue中的diff算法实现"/>
...
<img src="bef18a38/diff-vnode-children.png" width="100%" alt="vue中的diff算法实现"/>
...
<img src="bef18a38/diff-vnode-children-01.png" width="100%" alt="vue中的diff算法实现"/>
...
<img src="bef18a38/diff-vnode-children-02.png" width="100%" alt="vue中的diff算法实现"/>
...
<img src="bef18a38/diff-vnode-children-03.png" width="100%" alt="vue中的diff算法实现"/>
...
<img src="bef18a38/diff-vnode-children-04.png" width="100%" alt="vue中的diff算法实现"/>
...
<img src="bef18a38/diff-vnode-children-05.png" width="100%" alt="vue中的diff算法实现：在头尾见找可复用元素"/>
...
<img src="bef18a38/add-in-after.png" width="100%" alt="vue中的diff算法实现"/>
&nbsp;

2.newStartIdx右移，newEndIdx左移，直到遍历完旧children：

<img src="bef18a38/add-in-middle.png" width="100%" alt="vue中的diff算法实现"/>

3.新增的vnode都在前面了，由于是新的节点所以存在“newStartIdx右移”的情况，newStartIdx就保持不变了，而可复用的vnode在右边，随着一次次循环，newEndIdx则会左移：

<img src="bef18a38/add-in-before.png" width="100%" alt="vue中的diff算法实现"/>
