...
permalink: blog/automated-changelog-ci
...
![Test Commitlint-CLI](4d5c9147/test_commitlint.gif)
...
![Commitlint by hook](4d5c9147/commitlint_by_hook.gif)
...
![Test prompt-cli](4d5c9147/test_prompt-cli.gif)
...
![SemVer Manage](4d5c9147/Snipaste_2023-07-25_18-24-32.png)
...
npx standard-version -r patch
```
![Example for version manage](4d5c9147/Snipaste_2023-07-25_18-23-41.png)
...
![LifeCycle of npm-version](4d5c9147/Snipaste_2023-07-26_11-28-57.png)
...
![lifecycle of standard-version](4d5c9147/Snipaste_2023-07-26_21-57-36.png)
...
![](4d5c9147/Snipaste_2023-07-27_04-51-22.png)

**📢 注意**：*`standard-version` 触发的脚本是 `strandard-version.scripts.*`，而不是 `scripts.*`。*


![](4d5c9147/Snipaste_2023-07-26_20-14-55.png)
...
![work flow](4d5c9147/Snipaste_2023-07-26_11-57-45.png)
...
![](4d5c9147/Snipaste_2023-08-07_00-58-17.png)
