...
![OAuth2](https://assets-amu.pages.dev/blog/2022-10-07-03-23-41.png)
...
![令牌端点](https://assets-amu.pages.dev/blog/2022-10-07-12-10-49.png)

OAuth流程中的很多部分都使用标准的 HTTP请求和响应格式来相互通信。由于这些请求通 常都发生在资源拥有者和用户代理的可见范围之外，因此它们统称为后端信道通信

![](https://assets-amu.pages.dev/blog/2022-10-07-12-05-02.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-07-08-14-35.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-07-11-32-59.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-24-00-46-21.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-07-14-51-53.png)

在客户端凭据许可流程中不会颁发刷新令牌，因为我们认为客户端能够随时获取新令牌，无 须单独的资源拥有者参与，因此在这种情况下没有必要使用刷新令牌。 

客户端凭据许可类型没有任何直接的用户交互!它确实是为可信的后端系统直接 访问服务而准备的。

![](https://assets-amu.pages.dev/blog/2022-10-07-14-34-57.png)


### 资源拥有者凭据许可类型 

![](https://assets-amu.pages.dev/blog/2022-10-07-16-00-30.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-08-05-42-33.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-08-13-31-55.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-08-14-54-58.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-09-06-17-02.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-09-07-08-23.png)

内省请求

![](https://assets-amu.pages.dev/blog/2022-10-09-07-15-45.png)

内省请求的响应是一个 JSON 对象，用于描述令牌信息。它的内容与 JWT 的载荷相似，任 何有效的 JWT声明都可以包含在响应中。 

![](https://assets-amu.pages.dev/blog/2022-10-09-07-16-11.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-09-12-16-09.png)
...
![](https://assets-amu.pages.dev/blog/2022-10-24-03-52-06.png)
