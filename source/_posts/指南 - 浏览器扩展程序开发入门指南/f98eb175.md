---
title: 浏览器扩展程序开发入门指南
slugpath: guide/browser-extension-development
alias:
...
|![content_scripts、options、popup 和 background 的关系图](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-08_19-25-08.png)|
|:--:|
...
|![Popup Dasboard 效果示例图](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-08_12-29-52.png)|
|:--:|
...
|![Options Page](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-08_15-51-31.png)|
|:--:|
...
![嵌入式 Options Page 示意图](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-09_10-51-41.png)
...
|![加载本地扩展程序](https://isaaxite.github.io/assets/blog/BzVElZpUtNE4dueVPSp3.webp)|
|:--:|
...
|![content_script 输出的 console 示意](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-09_11-12-25.png)|
|:--:|
...
|![操作 `右键` > `inspect`，则呼起调试页面](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-09_11-23-46.png)|
|:--:|
...
![`inspect` 查看 console 的输出](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-09_11-32-44.png)

### 其他

**错误日志**，扩展程序卡片上会有 “Error” 按钮，点击可以查看错误日志。

![“Error” 按钮 - 查看错误日志](https://isaaxite.github.io/assets/blog/a9lAHCJZZrebOSKrkPRD.webp)
...
![点击 `Pack extension` 按钮进入打包流程](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-09_12-17-53.png)

选择你的扩展程序目录

![选择你的扩展程序目录](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-09_12-18-21.png)

点击 `Pack extension` 按钮进行打包。

![`Pack extension` 按钮](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-09_12-18-38.png)

![点击 `Pack extension` 按钮进行打包结果](https://isaaxite.github.io/assets/blog/Snipaste_2023-06-09_12-25-21.png)
...
![创建并设置一个开发者账号](https://isaaxite.github.io/assets/blog/adH2VFqS92VdzPTjsHtB.webp)

📝 **Hint**：需要支付 5 刀的注册费！

2️⃣ 上传你的 zip 包，并提交

![上传你的 zip 包，并提交 - 1](https://isaaxite.github.io/assets/blog/g06GNVoineSSnxt4N6Fy.webp)

![上传你的 zip 包，并提交 - 2](https://isaaxite.github.io/assets/blog/BiZituXHHZ74SIkwc3q7.webp)
