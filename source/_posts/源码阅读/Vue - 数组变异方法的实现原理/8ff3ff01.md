---
title: Vue 源码分析 - 数组变异方法的实现原理
slugpath: source-code-reading/vue/array-mutation
alias: blog/vue-array-mutation/
...
- Vue 版本：`v2.6.10`；
- Vue 2 变异数组文档：[Array Change Detection](https://v2.vuejs.org/v2/guide/list.html#Array-Change-Detection)
- 变异数组：`arrayMethods`；
- `arrayMethods` 源码位置：[src/core/observer/array.js](https://github.com/vuejs/vue/blob/v2.6.10/src/core/observer/array.js)。
- `arrayMethods` 被使用的位置：[src/core/observer/index.js](https://github.com/vuejs/vue/tree/v2.6.10/src/core/observer/index.js)

> [**变更方法**](https://v2.cn.vuejs.org/v2/guide/list.html#%E5%8F%98%E6%9B%B4%E6%96%B9%E6%B3%95)
>
...
源码位置：[src/core/util/lang.js](https://github.com/vuejs/vue/tree/v2.6.10/src/core/util/lang.js)
