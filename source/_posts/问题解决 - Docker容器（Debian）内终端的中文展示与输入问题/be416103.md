...
segment: debug/docker-debian-chinese
alias: 
- blog/debug-docker-debian-chinese/
- blog/resources/Docker容器（Debian）内终端的中文展示与输入问题/
...
![](https://assets-amu.pages.dev/blog/Snipaste_2023-02-27_20-24-42.png)
